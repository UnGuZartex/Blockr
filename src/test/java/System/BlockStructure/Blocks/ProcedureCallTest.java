...
//        assertTrue(call.hasProperConnections( new Stack<>()));
//    }
//
//    @Test
//    void hasProperConnections_procedureHasNoProperConnections() {
//        handler.connect(new IfBlock(), procedure.getSubConnectorAt(0));
//        assertFalse(procedure.hasProperConnections(new Stack<>()));
//        assertFalse(call.hasProperConnections(new Stack<>()));
//    }
//
//    @Test
//    void hasProperConnections_notConnectedOnBottom() {
//        assertFalse(callTop.getSubConnectorAt(0).isConnected());
//        assertTrue(procedureTop.hasProperConnections(new Stack<>()));
//        assertTrue(callTop.hasProperConnections(new Stack<>()));
//    }
//
//    @Test
//    void hasProperConnections_invalidOnBottom() {
//        assertTrue(callBottom.getSubConnectorAt(0).isConnected());
//        assertTrue(procedureBottom.hasProperConnections(new Stack<>()));
//        assertFalse(blockBottom.hasProperConnections(new Stack<>()));
//        assertFalse(callBottom.hasProperConnections(new Stack<>()));
//    }
//
//    @Test
...
//        assertTrue(procedure.hasProperConnections(new Stack<>()));
