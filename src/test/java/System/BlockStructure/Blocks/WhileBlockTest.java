...
class WhileBlockTest {
    ...
    void setUp() {
        ...
        condBlock1 = new StatementBlock(new PredicateFunctionality(new WallInFrontPredicate()));
        condBlock2 = new StatementBlock(new PredicateFunctionality(new WallInFrontPredicate()));
