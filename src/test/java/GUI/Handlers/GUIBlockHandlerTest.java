...
class GUIBlockHandlerTest {
    ...
    void guiBlockHandler_invalidPalettePanel() {
        assertThrows(IllegalArgumentException.class, () -> new GUIBlockHandler(null, programAreaPanel));
    }
    ...
    void handleMouseEvent_connectedBlocks() {
        ...
        mouseHandler.handleMouseEvent(MouseEvent.MOUSE_RELEASED, CORNER_X_PA + WIDTH/2, (int) (CORNER_Y_PA + HEIGHT*0.25));
        ...
        mouseHandler.handleMouseEvent(MouseEvent.MOUSE_PRESSED, functional.getX(), functional.getY());
        mouseHandler.handleMouseEvent(MouseEvent.MOUSE_RELEASED, CORNER_X_PA + WIDTH/2, (int) (CORNER_Y_PA + HEIGHT*0.25) + programAreaPanel.getBlocks().get(0).getTotalHeight());
        assertEquals(2, programAreaPanel.getBlocks().size());
        assertNotNull(programArea.getProgram());
        ...
        mouseHandler.handleMouseEvent(MouseEvent.MOUSE_PRESSED, CORNER_X_PA + WIDTH/2, yPos);
        mouseHandler.handleMouseEvent(MouseEvent.MOUSE_RELEASED, CORNER_X_PA + WIDTH/2, yPos + 100);
